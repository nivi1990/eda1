...
is.netinc.ok <- (housing$Income - housing$Expense) == housingNetIncome
```
...
```{r valpersqft}
housing$ValuePerSqFt <- housing$Vlaue/housing$SqFt
```
...
```{r}
housing$zValuePerSqFt <- (housing$ValuePerSqFt - mean(housing$ValuePerSqFt))/sd(housing$ValuePerSqFt)
